...
# a층 b호 : a-1층의 1호부터 b호까지 사람들의 수의 합
# k층 n호에는 몇명?
# 0층부터 시작. 각층은 1호부터 시작.
...
for t in range(1,T+1):
    k = int(input())
    n = int(input())
    # 예를들면, 1층 3호는, 0층 1호(1명) + 0층 2호(2명) + 0층 3호(3명)인 6명.
    # 2층 3호 -> 1층 1호(0층 1호(1명)) + 1층 2호(0층 1호(1명) + 0층 2호(2명)) + 1층 3호(0층 1호(1명) + 0층 2호(2명) + 0층 3호(3명))
    print(s(k,n))